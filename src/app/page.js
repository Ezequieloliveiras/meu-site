...
export default function Home() {
  return (
    <Grid container spacing={1}>
      ...
      <Grid item xs={12} style={{ backgroundColor: '#f9f9f9', padding: '50px 0', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '3rem', color: '#333', marginBottom: '20px', 
                       textAlign: 'center', '@media (max-width: 600px)': { fontSize: '2.5rem' } }}>
            Tenha um site incrível para o seu negócio!
          </h1>
          <p style={{ fontSize: '1.2rem', color: '#666', lineHeight: '1.6', marginBottom: '30px',
                      textAlign: 'center', '@media (max-width: 600px)': { fontSize: '1rem' } }}>
      ...
      <Grid item xs={12} style={{ backgroundColor: '#fff', padding: '50px 0', textAlign: 'center' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{ color: '#333', fontSize: '2.5rem', marginBottom: '40px', 
                       textAlign: 'center', '@media (max-width: 600px)': { fontSize: '2rem' } }}>
            Por que nos escolher?
          </h2>
          <Grid container spacing={3} justifyContent="center">
            <Grid item xs={12} sm={4}>
              <h3 style={{ color: '#007bff', fontSize: '2rem', marginBottom: '15px',
                           textAlign: 'center', '@media (max-width: 600px)': { fontSize: '1.5rem' } }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <Grid container spacing={3} justifyContent="center">
            <Grid item xs={12} sm={4}>
              ...
              <div style={{ maxWidth: '100%', height: 'auto', marginTop: '20px' }}>
                <img src="https://via.placeholder.com/500" alt="Sites Corporativos" style={{ maxWidth: '100%', height: 'auto' }} />
              </div>
            </Grid>
            <Grid item xs={12} sm={4}>
              <h3 style={{ color: '#007bff', fontSize: '2rem', marginBottom: '15px',
              ...
              <div style={{ maxWidth: '100%', height: 'auto', marginTop: '20px' }}>
                <img src="https://via.placeholder.com/500" alt="Lojas Online" style={{ maxWidth: '100%', height: 'auto' }} />
              </div>
            </Grid>
            <Grid item xs={12} sm={4}>
              <h3 style={{ color: '#007bff', fontSize: '2rem', marginBottom: '15px',
              ...
              <div style={{ maxWidth: '100%', height: 'auto', marginTop: '20px' }}>
                <img src="https://via.placeholder.com/500" alt="Portfólios de Arte" style={{ maxWidth: '100%', height: 'auto' }} />
              </div>
            </Grid>
          </Grid>
        </div>
